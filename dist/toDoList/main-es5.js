...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(authService, usersServise, title, router) {
                ...
                LoginComponent.prototype.onSubmit = function () {
                    ...
                    this.usersServise.getUserByEmail(email)
                        ...
                        if (user) {
                            if (user.password === _this.loginForm.value.password) {
                                _this.message.text = '';
                                ...
                                _this.message.showMessage('danger', 'Password is wrong');
                            }
                        }
                        else {
                            _this.message.showMessage('danger', 'Email does not exist');
                        }
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegistrationComponent = /** @class */ (function () {
                function RegistrationComponent(userService, router, title) {
                ...
                RegistrationComponent.prototype.onSubmit = function () {
                    ...
                    var _a = this.regForm.value, email = _a.email, password = _a.password, name = _a.name;
                    var user = new _shared_module_user_model__WEBPACK_IMPORTED_MODULE_5__["User"](email, password, name);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var fadeStateTrigger = Object(_angular_animations__WEBPACK_IMPORTED_MODULE_1__["trigger"])('fade', [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaseApi = /** @class */ (function () {
                ...
                BaseApi.prototype.delete = function (url, key, data) {
                    url = this.getUrl(url);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Task = /** @class */ (function () {
                function Task(name, description, priority, status, data, color, id) {
                    this.name = name;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SettingService = /** @class */ (function () {
                ...
                SettingService.prototype.onGreenTheme = function () {
                    this.isGreenTheme.emit(true);
                };
                SettingService.prototype.onBlueTheme = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreaterComponent = /** @class */ (function () {
                function CreaterComponent(taskService) {
                ...
                CreaterComponent.prototype.closeCreater = function () {
                    this.onCreaterCancel.emit();
                };
                CreaterComponent.prototype.onSubmit = function (form) {
                    var _this = this;
                    if (form.invalid) {
                        if (form.name) {
                    ...
                    var _a = form.value, name = _a.name, description = _a.description, priority = _a.priority, color = _a.color;
                    var task = new _shared_module_task_module__WEBPACK_IMPORTED_MODULE_4__["Task"](name, description, priority, "during", new Date(), color);
                    this.taskService.addTask(task)
                        .subscribe(function (t) {
                        _this.onTaskAdd.emit(t);
                    });
                };
                return CreaterComponent;
            }());
            CreaterComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditorComponent = /** @class */ (function () {
                function EditorComponent(taskService) {
                    this.taskService = taskService;
                ...
                EditorComponent.prototype.closeEditor = function () {
                ...
                EditorComponent.prototype.onSubmit = function (form) {
                    ...
                    this.taskService.editTask(this.editTask)
                        .subscribe(function () {
                        _this.onTaskEdit.emit(_this.editTask);
                    });
                };
                EditorComponent.prototype.removeTask = function () {
                    var _this = this;
                    console.log('remove');
                    this.taskService.deleteTask(this.editTask)
                        .subscribe(function () {
                        console.log('removed');
                        _this.onTaskRemoved.emit(_this.editTask);
                    });
                };
                EditorComponent.prototype.doneTask = function () {
                    var _this = this;
                    this.editTask.status = 'done';
                    this.taskService.editTask(this.editTask)
                        .subscribe(function () {
                        _this.onTaskDone.emit(_this.editTask);
                    });
                };
                EditorComponent.prototype.duringTask = function () {
                    var _this = this;
                    this.editTask.status = 'during';
                    this.taskService.editTask(this.editTask)
                        .subscribe(function () {
                        _this.onTaskDuring.emit(_this.editTask);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(taskService, authService, router, title) {
                    this.taskService = taskService;
                    this.authService = authService;
                    this.router = router;
                    this.title = title;
                ...
                HomeComponent.prototype.ngOnInit = function () {
                    ...
                    this.taskService.getTasks()
                        ...
                        _this.tasks = tasks;
                        _this.duringTasks = tasks.filter(function (item) { return item.status === 'during' && _this.priorityVisible[item.priority]; });
                        _this.doneTasks = tasks.filter(function (item) { return item.status === 'done' && _this.priorityVisible[item.priority]; });
                    });
                    this.viewList = true;
                ...
                HomeComponent.prototype.filterAdded = function (form) {
                    var _this = this;
                    console.log(form);
                    this.priorityVisible = form.value;
                    this.duringTasks = this.tasks.filter((function (item) { return item.status === 'during' && _this.priorityVisible[item.priority]; }), this);
                    console.log('ngDoCheck');
                    this.doneTasks = this.tasks.filter((function (item) { return item.status === 'done' && _this.priorityVisible[item.priority]; }), this);
                    console.log(this.priorityVisible);
                    $('.button_filter .dropdown-toggle').dropdown('hide');
                };
                HomeComponent.prototype.onViewList = function () {
                    this.viewList = true;
                };
                HomeComponent.prototype.onViewGrid = function () {
                    this.viewList = false;
                };
                HomeComponent.prototype.onSortDown = function () {
                    this.duringTasks.sort(function (a, b) { return Date.parse(a.data) - Date.parse(b.data); });
                    this.doneTasks.sort(function (a, b) { return Date.parse(a.data) - Date.parse(b.data); });
                };
                HomeComponent.prototype.onSortUp = function () {
                    console.log('befor', this.duringTasks);
                    this.duringTasks.sort(function (a, b) { return Date.parse(b.data) - Date.parse(a.data); });
                    this.doneTasks.sort(function (a, b) { return Date.parse(b.data) - Date.parse(a.data); });
                };
                HomeComponent.prototype.openTaskCreater = function () {
                    this.isCreaterVisible = true;
                };
                HomeComponent.prototype.closeTaskCreater = function () {
                    this.isCreaterVisible = false;
                };
                HomeComponent.prototype.taskAdded = function (task) {
                    this.duringTasks.unshift(task);
                    this.closeTaskCreater();
                };
                HomeComponent.prototype.openEditor = function (task) {
                    this.isEditorVisible = true;
                    this.editTask = task;
                };
                HomeComponent.prototype.closeEditor = function () {
                    this.isEditorVisible = false;
                };
                HomeComponent.prototype.closeTaskEditor = function () {
                    this.closeEditor();
                };
                HomeComponent.prototype.onTaskEdit = function (task) {
                    if (task.status === 'during') {
                        this.duringTasks.forEach(function (item, i, arr) {
                            if (item.id === task.id) {
                                arr[i] = task;
                            }
                        });
                        ...
                        this.doneTasks.forEach(function (item, i, arr) {
                            if (item.id === task.id) {
                                arr[i] = task;
                            }
                        });
                ...
                HomeComponent.prototype.onTaskRemoved = function (task) {
                    this.duringTasks.forEach(function (item, i, arr) {
                        if (item.id === task.id) {
                            arr.splice(i, 1);
                        }
                ...
                HomeComponent.prototype.onTaskDone = function (task) {
                    this.duringTasks.forEach(function (item, i, arr) {
                        if (item.id === task.id) {
                            arr.splice(i, 1);
                        }
                ...
                HomeComponent.prototype.onTaskDuring = function (task) {
                    this.doneTasks.forEach(function (item, i, arr) {
                        if (item.id === task.id) {
                            arr.splice(i, 1);
                        }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SettingsComponent = /** @class */ (function () {
                function SettingsComponent(authService, router, settingServuce, title) {
                    this.authService = authService;
                    this.router = router;
                ...
                SettingsComponent.prototype.onGreenTheme = function () {
                    console.log('greenTheme');
                    this.settingServuce.onGreenTheme();
                };
                SettingsComponent.prototype.onBlueTheme = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SystemComponent = /** @class */ (function () {
                function SystemComponent(router, settingService) {
                    this.router = router;
                ...
                SystemComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.settingService.isGreenTheme.subscribe(function (c) {
                        _this.isGreenThem = c;
                        console.log('settings=', _this.isGreenThem);
                    });
